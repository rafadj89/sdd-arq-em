...
function getDefaultData(){
    ...
    tasks:[
        ...
        t('g47','Reunión seguimiento Oracle — presentación arquitectura WAF','gerencial','resuelto','phase-1','integracion','normativo','alta','admin','2026-03-09','2026-03-09','Reunión de seguimiento con Oracle (9 Mar). Se presentó el documento Well-Architected Framework Review completo (35 servicios OCI, OKE Enhanced, Kafka, Full Stack DR). El equipo Oracle quedó impresionado con la arquitectura. Compromisos: (1) Oracle revisará a detalle la arquitectura, (2) Lunes 16 Mar revisan propuestas, (3) Oracle entregará créditos OCI para despliegue y pruebas E2E.'),
        t('g48','Evaluación arquitectura propuesta con insumos Oracle','gerencial','en_gestion','phase-1','integracion','tecnico','alta','admin','2026-03-03','2026-03-21','Evaluar la arquitectura propuesta del proyecto de electromovilidad con base en los insumos y recomendaciones proporcionados por Oracle. Documentar respaldo técnico, validación de componentes OCI, estimaciones de costos, y decisiones arquitectónicas soportadas por Oracle. Generar documento de respaldo con evidencia. ACTUALIZACIÓN: Oracle revisando a detalle la arquitectura — propuestas esperadas el 16 Mar.'),
        t('g8','Reunión Etecnit — plataforma mapareve.es (OCPI España)','gerencial','resuelto','phase-1','integracion','normativo','alta','admin','2026-03-09','2026-03-09','Reunión con Etecnit (9 Mar), proveedor español de tecnología para red eléctrica, creadores de www.mapareve.es — plataforma de información en tiempo real de rutas y puntos de recarga, disponibilidad y sugerencias de recarga por capacidad. Etecnit recolecta datos de todos los proveedores bajo protocolo OCPI 2.1.1. Compromisos: (1) Etecnit enviará cotización de servicios tecnológicos para acompañamiento en implementación de la Guía y desarrollo de la Plataforma, (2) Reunión técnica de seguimiento en 1 mes (~Abr 2026).'),
        ...
        // ═══════════════════════════════════════════════════════════════
        // TABLERO GERENCIAL — Compromisos reuniones Oracle + Etecnit (9 Mar 2026)
        // ═══════════════════════════════════════════════════════════════
        // -- Oracle --
        t('g49','Revisión propuestas Oracle — sesión lunes 16 Mar','gerencial','en_gestion','phase-1','integracion','tecnico','alta','admin','2026-03-16','2026-03-16','Sesión programada con equipo Oracle para revisar las propuestas de arquitectura derivadas de la presentación del WAF Review (9 Mar). Oracle presentará observaciones, recomendaciones y validación de los 35 servicios OCI propuestos. Preparar preguntas sobre sizing, DR, y licenciamiento.'),
        t('g50','Recepción y configuración créditos OCI Oracle','gerencial','por_gestionar','phase-1','infraestructura','tecnico','alta','admin','2026-03-16','2026-03-31','Oracle se comprometió a entregar créditos OCI para desplegar la arquitectura diseñada y realizar pruebas productivas del flujo end-to-end. Pendiente: recibir créditos, configurar tenancy, crear compartimentos, activar servicios base (OKE, Streaming, Autonomous DB, Vault, WAF).'),
        t('g51','Pruebas productivas end-to-end con créditos Oracle','gerencial','por_gestionar','phase-1','integracion','tecnico','alta','admin','2026-04-01','2026-04-30','Con los créditos OCI de Oracle, desplegar la arquitectura completa y ejecutar pruebas productivas del flujo end-to-end: ingesta CPO → Kafka → validación → ATP → Object Storage → portal público. Validar OKE Enhanced, Service Mesh, ArgoCD, observabilidad (Grafana/Prometheus/Loki), y Full Stack DR.'),
        t('g52','Seguimiento revisión detallada arquitectura Oracle','gerencial','en_gestion','phase-1','integracion','tecnico','alta','admin','2026-03-10','2026-03-21','Oracle se comprometió a revisar a detalle toda la arquitectura presentada en el documento WAF Review. Hacer seguimiento de la revisión, resolver consultas del equipo Oracle, y consolidar feedback en el documento de arquitectura.'),
        // -- Etecnit --
        t('g53','Recepción y evaluación cotización Etecnit','gerencial','por_gestionar','phase-1','integracion','normativo','alta','admin','2026-03-10','2026-03-28','Etecnit (España, www.mapareve.es) se comprometió a enviar cotización de servicios tecnológicos para: (1) Acompañamiento en la implementación de la Guía de Implementación Res. 40559, (2) Desarrollo de la Plataforma de Interoperabilidad. Evaluar propuesta técnica y económica. Etecnit tiene experiencia con OCPI 2.1.1 y recolección de datos de CPOs en España.'),
        t('g54','Reunión técnica Etecnit — seguimiento (~Abr 2026)','gerencial','por_gestionar','phase-1','integracion','tecnico','alta','admin','2026-04-07','2026-04-11','Reunión técnica de seguimiento con Etecnit programada para ~1 mes después de la reunión inicial (9 Mar). Temas: arquitectura técnica de mapareve.es, protocolo OCPI 2.1.1 vs 2.2.1, lecciones aprendidas de la implementación en España, modelo de datos, flujos de ingesta de CPOs, disponibilidad en tiempo real, sugerencias de recarga por capacidad.'),
        ...
        // ═══ DESARROLLO — Tareas derivadas reuniones Oracle + Etecnit (9 Mar 2026) ═══
        t('d84','Configuración tenancy OCI con créditos Oracle','desarrollo','backlog','phase-1','infraestructura','tecnico','alta','u-devops','2026-03-20','2026-04-05','Configurar tenancy OCI con créditos Oracle: compartimentos (DEV/QA/SANDBOX/PROD/DR), VCN con subnets, IAM policies, Cloud Guard, Landing Zone CIS Benchmark. Terraform IaC desde día 1. Validar acceso equipo completo.'),
        t('d85','Despliegue arquitectura OCI — prueba E2E con créditos','desarrollo','backlog','phase-1','infraestructura','tecnico','alta','u-devops','2026-04-01','2026-04-30','Desplegar arquitectura completa en OCI: OKE Enhanced (Managed Nodes E5), OCI Streaming (Kafka +5 topics), Autonomous DB (ATP), Object Storage (4 zonas), OCI Vault, WAF, API Gateway, Service Mesh, ArgoCD, Grafana+Prometheus+Loki. Ejecutar flujo E2E: CPO → ingesta → Kafka → validación → ATP → portal.'),
        t('d86','Análisis técnico mapareve.es — benchmarking OCPI','desarrollo','backlog','phase-1','arquitectura','tecnico','media','admin','2026-03-15','2026-04-07','Análisis técnico de la plataforma mapareve.es de Etecnit (España): arquitectura, protocolo OCPI 2.1.1 vs 2.2.1, modelo de datos, flujos de ingesta, funcionalidades (rutas en tiempo real, disponibilidad, sugerencias de recarga por capacidad). Benchmarking para la plataforma UPME. Preparar preguntas técnicas para la reunión de seguimiento (~Abr).')
    ],
    commitments:[
        ...
        {id:'c15',title:'Presentación arquitectura WAF a Oracle',owner:'Rafael A. Dominguez',date:'2026-03-09',type:'externo',status:'completado',obs:'Oracle impresionado con la arquitectura. 35 servicios OCI, OKE Enhanced, Full Stack DR.'},
        {id:'c16',title:'Revisión propuestas Oracle — lunes 16 Mar',owner:'Rafael A. Dominguez',date:'2026-03-16',type:'externo',status:'pendiente',obs:'Oracle presenta propuestas y validación de la arquitectura UPME.'},
        {id:'c17',title:'Recepción créditos OCI Oracle',owner:'Rafael A. Dominguez',date:'2026-03-31',type:'externo',status:'pendiente',obs:'Oracle entrega créditos para despliegue y pruebas E2E en OCI.'},
        {id:'c18',title:'Reunión Etecnit — mapareve.es (OCPI España)',owner:'Rafael A. Dominguez',date:'2026-03-09',type:'externo',status:'completado',obs:'Etecnit (España). Plataforma mapareve.es. OCPI 2.1.1. Cotización pendiente.'},
        {id:'c19',title:'Recepción cotización servicios Etecnit',owner:'Rafael A. Dominguez',date:'2026-03-28',type:'externo',status:'pendiente',obs:'Cotización acompañamiento implementación Guía + desarrollo Plataforma.'},
        {id:'c20',title:'Reunión técnica seguimiento Etecnit (~1 mes)',owner:'Rafael A. Dominguez',date:'2026-04-11',type:'externo',status:'pendiente',obs:'Sesión técnica: arquitectura mapareve.es, OCPI 2.1.1 vs 2.2.1, lecciones España.'}
    ],
    regulatoryMilestones:[
        ...
        {id:'r13',title:'Presentación arquitectura a Oracle (WAF Review)',date:'2026-03-09',status:'completado'},
        {id:'r14',title:'Reunión Etecnit — benchmarking OCPI España',date:'2026-03-09',status:'completado'},
        {id:'r15',title:'Revisión propuestas Oracle',date:'2026-03-16',status:'pendiente'},
        {id:'r16',title:'Créditos OCI Oracle — despliegue arquitectura',date:'2026-03-31',status:'pendiente'}
    ]};
}
